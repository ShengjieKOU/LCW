...
#include <ros/ros.h>
#include "adas_module/TrackArray.h"
#include "adas_module/track.h"
#include "adas_module/ld_LaneParam.h"
#include "adas_module/ld_Frame.h"
#include "adas_module/ld_Point.h"
#include "adas_module/ld_Coeff.h"
...
struct TARGETS_INFO{ // 多个目标信息
    ...
    bool _warning_flag = 0;  //warning flag
    int _warning_id;     //warning id
};
...
class CCommon{
    ...
    void Update_Target_Status(adas_module::TrackArray msg); //根据曲率半径等转换到实际的位置 速度 加速度

    void Target_Classified_Fusion(adas_module::TrackArray msg); //using fusion data to segment which lane object is in;
  
    void LaneParam_set(adas_module::ld_Frame msg);
